...
The first part of the output shows the expected input values, where the main results are shown in the bottom portion, mainly, `Estimated Power`. Under this set of values, our power to detect a mean difference is 79.51%. Furthermore, we can look at the power to detect heterogenity among included studies by examining the `Estimated Power for Test of Homogeneity` output, which for this set of values is 100%
...
Given, this set of expected values, we have 82.73% to detect between-group differences and 82.5% to dtect within-group differences.
...
#> 
#>  Number of groups:                              2 
#>  Expected Effect Sizes:                         0.1494431 0.3432216 
#>  Expected Sample Size(per group):               20 
#>  Expected Number of Studies;                    50 
#>  Expected heterogenity(t^2):                    large 
#> 
#>  Estimated Power for between-group moderation:  0.05005061 
