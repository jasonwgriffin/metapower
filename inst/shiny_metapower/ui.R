                                ...
                                sidebarLayout(
                                  sidebarPanel(
                                    ...
                                    fluidRow(column(12,
                                                    ...
                                                    sliderInput(inputId = "mod_d_n", h3("Number of Participants (Total)"), min = 2, max = 300, value = 40),
                                                    numericInput(inputId = "mod_d_n_groups", h3("Number of mods"), min = 2, max = 10, value = 2),
                                                    textOutput("md_d_k")),
                                             dashboardBody( tags$head(tags$style(HTML('.form-group, .selectize-control { margin-bottom: 5px;}.box-body {padding-bottom: 5px;}'))),
                                ...
                                sidebarLayout(
                                  sidebarPanel(
                                    ...
                                    fluidRow(column(12,
                                                    ...
                                                    sliderInput(inputId = "mod_c_n", h3("Number of Participants (total)"), min = 2, max = 300, value = 40),
                                                    numericInput(inputId = "mod_c_n_groups", h3("Number of Groups"), min = 2, max = 10, value = 2),
                                                    textOutput("md_c_k")),

                                             shinydashboard::box(width = 12, title = "mod Effect Sizes",
                                                                 splitLayout(
                                ...
                                sidebarLayout(
                                  sidebarPanel(
                                    ...
                                    fluidRow(column(12,
                                                    ...
                                                    sliderInput(inputId = "mod_or_n", h3("Number of Participants (total)"), min = 2, max = 300, value = 40),
                                                    numericInput(inputId = "mod_or_n_groups", h3("Number of mods"), min = 2, max = 10, value = 2),
                                                    textOutput("md_or_k"),
                                                    br()),
                                             column(width = 12,offset = 0,
